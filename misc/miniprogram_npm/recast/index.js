...
__DEFINE__(1562154355213, function(require, module, exports) {
;
...
}, function(modId) {var map = {"./lib/types":1562154355214,"./lib/parser":1562154355215,"./lib/printer":1562154355222}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1562154355214, function(require, module, exports) {
;
function __export(m) {
...
__DEFINE__(1562154355215, function(require, module, exports) {
...
}, function(modId) { var map = {"./types":1562154355214,"./options":1562154355216,"./lines":1562154355219,"./comments":1562154355221,"./util":1562154355218}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1562154355216, function(require, module, exports) {
...
}, function(modId) { var map = {"../parsers/esprima":1562154355217}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1562154355217, function(require, module, exports) {
...
}, function(modId) { var map = {"../lib/util":1562154355218,"esprima":1562154355217}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1562154355218, function(require, module, exports) {
...
}, function(modId) { var map = {"./types":1562154355214}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1562154355219, function(require, module, exports) {
...
}, function(modId) { var map = {"./options":1562154355216,"./util":1562154355218,"./mapping":1562154355220}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1562154355220, function(require, module, exports) {
;
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
}, function(modId) { var map = {"./util":1562154355218}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1562154355221, function(require, module, exports) {
...
}, function(modId) { var map = {"./types":1562154355214,"./lines":1562154355219,"./util":1562154355218}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1562154355222, function(require, module, exports) {
...
}, function(modId) { var map = {"./comments":1562154355221,"./lines":1562154355219,"./options":1562154355216,"./patcher":1562154355223,"./types":1562154355214,"./fast-path":1562154355224,"./util":1562154355218}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1562154355223, function(require, module, exports) {
...
}, function(modId) { var map = {"./lines":1562154355219,"./types":1562154355214,"./util":1562154355218,"./fast-path":1562154355224}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1562154355224, function(require, module, exports) {
;
var __importDefault = (this && this.__importDefault) || function (mod) {
    return (mod && mod.__esModule) ? mod : { "default": mod };
};
...
}, function(modId) { var map = {"./types":1562154355214,"./util":1562154355218}; return __REQUIRE__(map[modId], modId); })
return __REQUIRE__(1562154355213);
})()
